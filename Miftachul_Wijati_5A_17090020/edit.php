...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <a class="navbar-brand" href="#">CRDU Data</a>
  ...
  <div class="container" style="margin-top:20px">
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM data_pasien WHERE id='$id'") or die(mysqli_error($koneksi));
    ...
    if(isset($_POST['submit'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE data_pasien SET nama='$nama', username='$username', password='$password', email='$email' WHERE id='$id'") or die(mysqli_error($koneksi));
